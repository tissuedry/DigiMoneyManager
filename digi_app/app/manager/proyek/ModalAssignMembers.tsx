...
type ModalAssignMembersProps = {
  showAssignMembers: Project | null;
  setShowAssignMembers: (p: Project | null) => void;
  members: Member[];
  selectedProjectMembers: { userId: number; role: string }[];
  setSelectedProjectMembers: React.Dispatch<React.SetStateAction<any[]>>;
  formError: string;
  submitting: boolean;
  handleSaveMembers: (e: React.FormEvent) => void;
};

export default function ModalAssignMembers({
  showAssignMembers,
  setShowAssignMembers,
  members,
