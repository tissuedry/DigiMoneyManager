...
type ModalDetailBudgetProps = {
  showDetailBudgetModal: boolean;
  setShowDetailBudgetModal: (val: boolean) => void;
        ...
        <div style={{
          ...
          {posAnggaran.length > 0 ? (
            posAnggaran.map((pos: any, idxPos: number) => {
              ...
              const processedSubs = (pos.subAnggaran || []).map((sub: any) => {
                ...
                return {
                  ...sub,
                  calculatedAlokasi: totalAlokasiSubDariKet,
                  calculatedTerpakai: totalTerpakaiSubDariKet,
                };
              });
